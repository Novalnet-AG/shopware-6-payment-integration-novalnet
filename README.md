...
#### Follow the below steps and run each command in your terminal from the shop root directory
 ...
 ```
 composer require novalnet/shopware6-payment:12.8.1-p2
 ```
