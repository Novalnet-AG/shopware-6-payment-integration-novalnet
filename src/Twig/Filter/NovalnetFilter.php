    ...
    */
    ...
    public function getFilters(): array
    {
        return [
            ...
            new TwigFilter('getPaymentMethodErrorMessage', [$this->helper, 'getPaymentMethodErrorMessage']),
        ];
    }
    ...
    public function getPaymentDetails(SalesChannelContext $salesChannelContext, string $customerNo): ?array
    {
        $customerDetails = [];
        $customerDetails = $this->transactionHelper->getCustomerPaymentDetails($salesChannelContext->getContext(), $customerNo);
