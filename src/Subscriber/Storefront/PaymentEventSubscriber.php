...
class PaymentEventSubscriber implements EventSubscriberInterface
{
    ...
    public function afterPaymentMethodLoaded(EntityLoadedEvent $event): void
    {
        if (!empty($this->request) && !empty($this->request->get('paymentMethodId'))) {
            ...
            if (($this->request->get('novalnetcreditcardId') && $this->request->get('novalnetcreditcardId') == $this->request->get('paymentMethodId')) || ($this->request->get('novalnetcreditcardFormId') && $this->request->get('novalnetcreditcardFormId') == $this->request->get('paymentMethodId'))) {
                $paymentMethod = 'novalnetcreditcard';
            } elseif (($this->request->get('novalnetsepaId') && $this->request->get('novalnetsepaId') == $this->request->get('paymentMethodId')) || ($this->request->get('novalnetsepaFormId') && $this->request->get('novalnetsepaFormId') == $this->request->get('paymentMethodId')) || $this->request->get('doForceSepaPayment')) {
                $paymentMethod = 'novalnetsepa';
            } elseif (($this->request->get('novalnetsepaguaranteeId') && $this->request->get('novalnetsepaguaranteeId') == $this->request->get('paymentMethodId')) || ($this->request->get('novalnetsepaguaranteeFormId') && $this->request->get('novalnetsepaguaranteeFormId') == $this->request->get('paymentMethodId'))) {
