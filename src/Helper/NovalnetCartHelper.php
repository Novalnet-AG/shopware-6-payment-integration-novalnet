...
class NovalnetCartHelper
{
    ...
    public function updateShippingMethod(string $shippingMethodId, SalesChannelContext $salesChannelContext): SalesChannelContext
    {
		...
		$dataBag->add([
			...
			SalesChannelContextService::LANGUAGE_ID => $salesChannelContext->getContext()->getLanguageId(),
     ...
     * @param SalesChannelContext $salesChannelContext
     * @param string|null $salesChannelContext
     *
     * @return SalesChannelContext
     */
     ...
     */
    public function getAvailableShippingMethod(string $countryCode, SalesChannelContext $salesChannelContext)
    {
		$dataBag = new DataBag();
     ...
     * @return SalesChannelContext|null
     */
    public function getFormattedCart(Cart $cart, SalesChannelContext $salesChannelContext)
    {
		$orderDetails = [];
	...
	private function getAddressData(array $response, SalesChannelContext $salesChannelContext, $type = 'billing'): array
	{
		...
		return [
            ...
            'additionalAddressLine1' => $serverData['addressLines'],
