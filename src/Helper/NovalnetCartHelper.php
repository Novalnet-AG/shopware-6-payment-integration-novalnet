...
class NovalnetCartHelper
{
    ...
    public function updateShippingMethod(string $shippingMethodId, SalesChannelContext $salesChannelContext): SalesChannelContext
    {
        ...
        $dataBag->add([
            ...
            SalesChannelContextService::LANGUAGE_ID => !empty($salesChannelContext->getSalesChannel()->getLanguageId()) ? $salesChannelContext->getSalesChannel()->getLanguageId() : $salesChannelContext->getContext()->getLanguageId(),
     ...
     * @return SalesChannelContext
     */
    public function updatePaymentMethodId(string $paymentMethodId, SalesChannelContext $salesChannelContext): SalesChannelContext
    {
        $dataBag = new DataBag();
        $dataBag->add([
    ...
    public function updateCustomer(CustomerEntity $customer, array $response, SalesChannelContext $salesChannelContext): void
    {
        ...
        if ($addresses == null) {
            ...
            $criteria->addAssociation('addresses');
            /** @var CustomerEntity|null $customerAddress */
    ...
    private function getAddressData(array $response, SalesChannelContext $salesChannelContext, $type = 'billing'): array
    {
        ...
        return [
            ...
            'phoneNumber' => isset($serverData['phoneNumber']) ? $serverData['phoneNumber'] : '',
            'countryId' => $countryId,
    ...
    public function updateCouponCode(Cart $cart, string $couponCode, SalesChannelContext $salesChannelContext): ?Cart
    {
