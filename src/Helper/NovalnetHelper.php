...
class NovalnetHelper
{
   ...
   /**
    ...
    {
        return $this->shopVersion . '-NN' . '13.4.2';
    }
    ...
    public function getNovalnetIframeResponse(string $saleschannelId, string $customerId, array $requiredFields, Context $context, string $endPoint, string $type = '') :array 
    {
        ...
        $parameters['transaction'] = [
            ...
            'system_ip'      => $this->getIp('SYSTEM'),
            'system_name'    => 'shopware6',
            'system_version' => $this->getVersionInfo($context) . '-NNT' . $this->getThemeName($saleschannelId, $context),
        ];
    ...
    public function getNovalnetRequestData(float $amount, string $orderNumber, array $data, SalesChannelContext $salesChannelContext) :array 
    {
        ...
        $parameters['transaction'] = [
            ...
            'system_name'    => 'Shopware6',
            'system_ip'      => $this->getIp('SYSTEM'),
            'system_version' => $this->getVersionInfo($salesChannelContext->getContext()),
        ];
