...
class NovalnetHelper
{
    ...
    {
        return $this->shopVersion . '-NN' . '12.8.1-p2';
    }
    ...
    public function getApplePayInfo(): bool
    {
        ...
        return stripos($userAgent, 'Mac OS') !== false
    ...
    public function formBasicComments(array $input, Context $context, ?string $languageId = null): string
    {
        ...
        if (in_array($input ['transaction']['payment_type'], ['CREDITCARD' ,'DIRECT_DEBIT_SEPA','GOOGLEPAY', 'APPLEPAY', 'DIRECT_DEBIT_ACH']) && (isset($input['transaction']['status']) && $input['transaction']['status'] === 'CONFIRMED') && (isset($input['transaction']['amount']) && $input['transaction']['amount'] == 0 ) && $input['isZeroAmountBooking']) {
