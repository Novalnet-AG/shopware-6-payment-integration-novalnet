...
class NovalnetHelper
{
    ...
    {
        return $this->shopVersion . '-NN13.5.6-p1';
    }
    ...
    public function getNovalnetIframeUrl(SalesChannelContext $salesChannelContext, $transaction, string $type = ''): string
    {
        ...
        $response = $this->getNovalnetIframeResponse($salesChannelContext->getSaleschannel()->getId(), $salesChannelContext->getCustomer()->getId(), $requiredFields, $salesChannelContext->getContext(), $type);
     ...
     * @param string $customerId The customer ID the request is for.
     ...
     * @return array
     */
    public function getNovalnetIframeResponse(string $saleschannelId, string $customerId, array $requiredFields, Context $context, string $type = ''): array
    {
