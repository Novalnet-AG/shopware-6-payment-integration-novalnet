...
class NovalnetHelper
{
    ...
    */
    ...
    {
        return $this->shopVersion . '-NN' . '13.4.4';
    }
    ...
    */
    ...
    public function getPaymentMethodErrorMessage(SalesChannelContext $salesChannelContext): string
    {
        $localeCode = $this->getLocaleCodeFromContext($salesChannelContext->getContext(), true);
        $errorMessage = sprintf($this->translator->trans('NovalnetPayment.text.noPaymentMethodErrorMsg', [], null, $localeCode));
