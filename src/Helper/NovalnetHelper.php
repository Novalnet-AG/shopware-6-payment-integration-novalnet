...
class NovalnetHelper
{
    ...
    {
        return $this->shopVersion . '-NN' . '12.5.0';
    }
     ...
     * @return string
     */
    public function getLocaleCodeFromContext(Context $context, bool $wallet = false): string
    {
    ...
    public function formBasicComments(array $input, Context $context) : string
    {
        ...
        if($input ['transaction']['payment_type'] == 'GOOGLEPAY' && !empty($input['transaction']['payment_data']))
        {
