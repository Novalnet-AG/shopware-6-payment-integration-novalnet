    ...
    */
	...
	public function updateChangePayment(array $input, string $orderId, Context $context, bool $ordeUpdatedPayment = false)
    {
        ...
        $insertData = [
            ...
            'paidAmount' => 0,
            'amount' => isset($input['transaction']['amount']) ? $input['transaction']['amount'] : 0,
            ...
            'customerNo' => !empty($input['customer']['customer_no']) ? $input['customer']['customer_no'] : '',
             'additionalDetails' => $this->helper->serializeData([
                'payment_name' => $this->helper->getUpdatedPaymentName($paymentType, $this->helper->getLocaleCodeFromContext($context, true)),
                'change_payment' => true,
                'subscription' => [
					'payment_details' => [
						'type' => $paymentType,
    ...
    public function getUpdatedNextDate($subscription): string
    {
		...
		$interval = (int) $subscription->getInterval();
