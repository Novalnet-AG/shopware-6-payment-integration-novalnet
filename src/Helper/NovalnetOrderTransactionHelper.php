    ...
    */
    ...
    public function getFinishNovalnetComments(string $comments) : ?string
    {
        if (!empty($comments)) {
         ...
         return isset($finishNovalnetComments[0]) && !empty($finishNovalnetComments[0])  ? $finishNovalnetComments[0] : $comments;
    }
     ...
     *
     */
    public function managePaymentStatus(string $status, string $transactionId, Context $context)
    {
        if ($status == 'paid') {
