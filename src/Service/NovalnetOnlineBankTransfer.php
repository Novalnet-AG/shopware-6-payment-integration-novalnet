...
class NovalnetOnlineBankTransfer extends AbstractNovalnetPaymentHandler
{
    /** @var string */
    ...
    public function pay(Request $request, PaymentTransactionStruct $transaction, Context $context, ?Struct $validateStruct): ?RedirectResponse
    {
        ...
        try {
            ...
            $response = $this->handlePaymentProcess($context, $transactionDetails, $redirectUrl, $request);
     ...
     * @return void
     */
    public function generatePaymentParameters($transaction, array &$parameters, string $salesChannelId, string $returnUrl, ?Request $data = null): void
    {
