...
class NovalnetOnlineBankTransfer extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'ONLINE_BANK_TRANSFER';
    
    /** @var string */
    protected $paymentCode         = 'novalnetonlinebanktransfer';

    /** @var string */
    protected $paymentHandler      = NovalnetOnlineBankTransfer::class;
    ...
    protected $translations        = [
        'de-DE' => [
            'name'        => 'Onlineüberweisung',
            'description' => 'Sie werden auf die Banking-Seite weitergeleitet. Bitte schließen oder aktualisieren Sie den Browser nicht, bis die Zahlung abgeschlossen ist.',
        ],
        'en-GB' => [
            'name'        => 'Online bank transfer',
            'description' => 'You will be redirected to banking page. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
