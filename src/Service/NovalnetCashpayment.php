...
class NovalnetCashpayment extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    /** @var string */
    ...
    {
        if (!empty($this->paymentSettings['NovalnetPayment.settings.cashpayment.dueDate'])) {
            $parameters['transaction'] ['due_date']= $this->helper->formatDueDate($this->paymentSettings['NovalnetPayment.settings.cashpayment.dueDate']);
        }
    }
    ...
    {
        return $this->helper->formSlipDetails($response, $context);
    }
}
