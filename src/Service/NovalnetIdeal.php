...
class NovalnetIdeal extends AbstractNovalnetPaymentHandler
{
    /** @var string */
    ...
    protected $translations        = [
        'de-DE' => [
            'name'        => 'iDEAL | Wero',
            'description' => 'Sie werden zu iDEAL | Wero weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist.',
        ],
        'en-GB' => [
            'name'        => 'iDEAL | Wero',
            'description' => 'You will be redirected to iDEAL | Wero. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
