...
class NovalnetIdeal extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'IDEAL';
    
    /** @var string */
    protected $paymentCode         = 'novalnetideal';

    /** @var string */
    protected $paymentHandler      = NovalnetIdeal::class;
    
    /** @var int */
    protected $position            = -1013;

    /** @var array */
    protected $translations        = [
        'de-DE' => [
            'name'        => 'iDEAL',
            'description' => 'Sie werden zu iDEAL weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist.',
        ],
        'en-GB' => [
            'name'        => 'iDEAL',
            'description' => 'You will be redirected to iDEAL. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
