...
class NovalnetWeChatPay extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'WECHATPAY';
    
    /** @var string */
    protected $paymentCode         = 'novalnetwechatpay';

    /** @var string */
    protected $paymentHandler      = NovalnetWeChatPay::class;
    ...
    protected $translations        = [
        ...
        'en-GB' => [
            'name'        => 'WeChatPay',
            'description' => 'You will be redirected to WeChat Pay. Please don’t close or refresh the browser until the payment is completed.',
        ],
    ];
