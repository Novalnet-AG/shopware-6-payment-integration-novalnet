...
class NovalnetSepaInstalment extends AbstractNovalnetPaymentHandler
{
    ...
    public function pay(Request $request, PaymentTransactionStruct $transaction, Context $context, ?Struct $validateStruct): ?RedirectResponse
    {
        try {
            ...
            $response = $this->handlePaymentProcess($context, $transactionDetails, $transaction->getReturnUrl(), $request);
    ...
    public function generatePaymentParameters($transaction, array &$parameters, string $salesChannelId, string $returnUrl, ?Request $data = null): void
    {
        ...
        $this->setPaymentToken($this->paymentCode, $sessionData, $parameters, $data);
        ...
        if (empty($parameters ['transaction'] ['payment_data'] ['token'])) {
            ...
            $parameters['transaction'] ['payment_data']['account_holder'] = $sessionData['accountHolder'] ?? $parameters['customer']['first_name'] . ' ' . $parameters['customer']['last_name'];
