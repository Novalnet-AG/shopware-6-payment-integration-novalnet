...
class NovalnetAliPay extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'ALIPAY';
    
    /** @var string */
    protected $paymentCode         = 'novalnetalipay';

    /** @var string */
    protected $paymentHandler      = NovalnetAliPay::class;
    
    /** @var int */
    protected $position            = -1003;

    /** @var array */
    protected $translations        = [
        'de-DE' => [
            'name'        => 'AliPay',
            'description' => 'Sie werden zu Alipay weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist.',
        ],
        'en-GB' => [
            'name'        => 'AliPay',
            'description' => 'You will be redirected to Alipay. Please don’t close or refresh the browser until the payment is completed.',
        ],
    ];
