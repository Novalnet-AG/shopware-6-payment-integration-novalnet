...
class NovalnetPrepayment extends AbstractNovalnetPaymentHandler
{
    /** @var string */
    ...
    {
        $dueDate = $this->helper->getNovalnetPaymentSettings('NovalnetPayment.settings.prepaymentDueDate', $salesChannelId);
