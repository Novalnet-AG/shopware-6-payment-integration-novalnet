...
class NovalnetPayconiq extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    /** @var string */
    protected $novalnetPaymentType = 'PAYCONIQ';

    /** @var string */
    protected $paymentCode         = 'novalnetpayconiq';

    /** @var string */
    protected $paymentHandler      = NovalnetPayconiq::class;

    /** @var int */
    protected $position            = -1028;

    /** @var array */
    protected $translations        = [
        'de-DE' => [
            'name'        => 'Payconiq',
            'description' => 'Bezahlen Sie sicher direkt von Ihrem Bankkonto.',
        ],
        'en-GB' => [
            'name'        => 'Payconiq',
            'description' => 'Pay securely directly from your bank account.',
        ],
    ];
