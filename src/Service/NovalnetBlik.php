...
class NovalnetBlik extends AbstractNovalnetPaymentHandler
{
    /** @var string */
    protected $novalnetPaymentType = 'BLIK';

    /** @var string */
    protected $paymentCode         = 'novalnetblik';

    /** @var string */
    protected $paymentHandler      = NovalnetBlik::class;

    /** @var int */
    protected $position            = -1025;

    /** @var array */
    protected $translations        = [
        'de-DE' => [
            'name'        => 'Blik',
            'description' => 'Sie werden zu Blik weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist',
        ],
        'en-GB' => [
            'name'        => 'Blik',
            'description' => 'You will be redirected to Blik. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
