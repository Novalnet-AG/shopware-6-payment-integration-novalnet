...
abstract class AbstractNovalnetPaymentHandler extends AbstractPaymentHandler
{
     ...
     */
    abstract public function generatePaymentParameters($transaction, array &$parameters, string $salesChannelId, string $returnUrl, ?Request $data = null): void;
     ...
     * @return array
     */
    public function handlePaymentProcess(Context $context, OrderTransactionEntity $transaction, string $returnUrl, ?Request $request = null)
    {
        $parameters = $this->generateBasicParameters($context, $transaction);
        $this->generatePaymentParameters($transaction, $parameters, $transaction->getOrder()->getSalesChannel()->getId(), $returnUrl, $request);
     ...
     */
    public function setPaymentToken(string $paymentType, array $sessionData, array &$parameters, ?Request $request = null): void
    {
