...
class NovalnetEps extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'EPS';
    
    /** @var string */
    protected $paymentCode         = 'novalneteps';

    /** @var string */
    protected $paymentHandler      = NovalnetEps::class;
    
    /** @var int */
    protected $position            = -1008;

    /** @var array */
    protected $translations        = [
        'de-DE' => [
            'name'        => 'eps',
            'description' => 'Sie werden zu eps weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist',
        ],
        'en-GB' => [
            'name'        => 'eps',
            'description' => 'You will be redirected to eps. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
