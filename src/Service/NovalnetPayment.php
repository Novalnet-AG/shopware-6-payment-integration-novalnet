    ...
    */
    ...
    {  
        try {
            ...
            $customFields = ['novalnet_comments' => $orderComments, 'novalnet_payment_name' => $this->helper->getUpdatedPaymentName($response['transaction']['payment_type'] ?? 'NOVALNET_PAYMENT', $locale), 'swag_paypal_resource_id' => (string) $response['transaction']['tid']];
