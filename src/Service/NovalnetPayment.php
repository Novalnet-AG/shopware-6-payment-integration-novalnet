...
class NovalnetPayment extends AbstractPaymentHandler
{
     ...
     */
    /**
     * Called when the payment has been finalized.
     * This event is triggered after the customer has been redirected back to the shop.
     * You can use this event to update the order status.
     */
     ...
     *
     * @param NovalnetPaymentTransactionEntity $transaction
     */
