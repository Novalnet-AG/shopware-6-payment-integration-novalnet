...
class NovalnetSofort extends AbstractNovalnetPaymentHandler implements AsynchronousPaymentHandlerInterface
{
    
    /** @var string */
    protected $novalnetPaymentType = 'ONLINE_TRANSFER';
    
    /** @var string */
    protected $paymentCode         = 'novalnetsofort';

    /** @var string */
    protected $paymentHandler      = NovalnetSofort::class;
    ...
    protected $translations        = [
        'de-DE' => [
            ...
            'description' => 'Sie werden zu Sofortüberweisung weitergeleitet. Um eine erfolgreiche Zahlung zu gewährleisten, darf die Seite nicht geschlossen oder neu geladen werden, bis die Bezahlung abgeschlossen ist.',
        ],
        'en-GB' => [
            'name'        => 'Sofort',
            'description' => 'You will be redirected to Sofort. Please don’t close or refresh the browser until the payment is completed',
        ],
    ];
