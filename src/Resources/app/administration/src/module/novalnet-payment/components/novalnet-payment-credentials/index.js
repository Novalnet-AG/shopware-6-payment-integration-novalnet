...
Component.register('novalnet-payment-credentials', {
    ...
    methods: {
        ...
        onCheckApi() {
            ...
            if (this.actualConfigData['NovalnetPayment.settings.accessKey'] === '' && this.actualConfigData['NovalnetPayment.settings.accessKey'] === '') {
        ...
        createdComponent() {
            ...
            if (this.actualConfigData !== undefined && this.isRequested !== this.selectedSalesChannelId) {
                ...
                if (apiActivationKey !== undefined && apiActivationKey !== '' && paymentAccessKey !== undefined && paymentAccessKey !== '') {
                    ...
                    this.NovalPaymentApiCredentialsService.validateApiCredentials(apiActivationKey, paymentAccessKey)
                        .then((response) => {
        ...
        configureWebhookUrl() {
            ...
            if (callbackUrl) {
                ...
                this.NovalPaymentApiCredentialsService.configureWebhookUrl(callbackUrl, productActivationKey, accessKey)
                    .then((response) => {
                        ...
                        } else if (response.result.status_text !== undefined && response.result.status_text != null) {
                            this.createNotificationError({
