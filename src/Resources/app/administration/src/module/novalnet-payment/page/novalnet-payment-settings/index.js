     ...
     watch: {
        config: {
            ...
            handler() {
                ...
                this.NovalPaymentApiCredentialsService.getShopVersion().then((shopVersion) => {
					if(shopVersion != '' && shopVersion != undefined && shopVersion.version  >= '6.5.0.0'  ) {
						
						this.shopVersion = true;
					}
				}).catch((errorResponse) => {
