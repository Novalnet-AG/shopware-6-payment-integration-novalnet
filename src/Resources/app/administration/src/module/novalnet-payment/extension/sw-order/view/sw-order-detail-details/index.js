					...
					this.NovalPaymentApiCredentialsService.getNovalnetAmount(order.orderNumber).then((payment) => {
						...
						{ 
							if(payment.data.gatewayStatus) {
                                ...
                                } else if ((payment.data.paymentType == 'CREDITCARD' || payment.data.paymentType == 'DIRECT_DEBIT_SEPA' || payment.data.paymentType == 'GOOGLEPAY' ) && Number(payment.data.amount) == 0 && this.orderAmount != 0 )
                                {
