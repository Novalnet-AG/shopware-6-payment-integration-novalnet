					...
					this.NovalPaymentApiCredentialsService.getNovalnetAmount(order.orderNumber).then((payment) => {
						...
						if(payment.data != '' && payment.data != undefined)
						{
							if(payment.data.gatewayStatus) {
                                ...
                                else if (((payment.data.paymentType == 'CREDITCARD') || (payment.data.paymentType == 'DIRECT_DEBIT_SEPA') || (payment.data.paymentType == 'GOOGLEPAY') || (payment.data.paymentType == 'DIRECT_DEBIT_ACH') || (payment.data.paymentType == 'APPLEPAY')) && Number(payment.data.amount) == 0 && this.orderAmount != 0 && payment.data.gatewayStatus !='FAILURE' )
                                {
