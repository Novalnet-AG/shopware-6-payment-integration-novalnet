...
export default class NovalnetPayment extends window.PluginBaseClass {
    init() {
    ...
    _displayErrorMsg(errorMessage, messageType) {
        ...
        if(messageType == 'danger'){
			parentDiv.className= "alert alert-danger alert-has-icon";
		} else {
			parentDiv.className= "alert alert-info alert-has-icon";
		}
