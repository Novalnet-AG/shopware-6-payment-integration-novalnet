...
export default class NovalnetPayment extends Plugin {
        ...
        paymentName.forEach((element) => {
            ...
            paymentRadioButton.forEach((payment) => {
                ...
                payment.addEventListener('click', () => {
                    if (element != undefined && payment != undefined)
                    {
    ...
    showPaymentForm( el, paymentName ) {
        ...
        if( paymentMethodId !== undefined && paymentMethodId.value !== '' && el.value === paymentMethodId.value )
        {
            ...
            {
                document.getElementById(paymentName + "ZeroAmountNotify").style.display = "block";
            }
            ...
            if( document.getElementById(paymentName + "ZeroAmountNotify") !== undefined && document.getElementById(paymentName + "ZeroAmountNotify") !== null )
            {
                document.getElementById(paymentName + "ZeroAmountNotify").style.display = "none";
            }
        }
    }
