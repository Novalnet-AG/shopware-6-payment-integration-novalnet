	...
	*/
    ...
    private function getHtmlTemplateEn(): string
    {
		...
		<p>
			...
			{{ order.transactions|last.paymentMethod.translated.description }}<br>
			<br>
						...
						<tbody>
							...
							{% for value in instalmentData %}
								...
								<tr>
									...
									<td style="border-bottom:1px solid #cccccc;">{{ instalmentData[count].cycleDate ? instalmentData[count].cycleDate|date("d/m/Y"): "-" }}</td>
								<tr>
								{% set count = count + 1 %}
							{% endfor %}	
						</tbody>
