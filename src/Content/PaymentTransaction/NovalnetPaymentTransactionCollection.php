 ...
 * @method NovalnetPaymentTransactionEntity|null get(string $key)
 * @method NovalnetPaymentTransactionEntity|null first()
 * @method NovalnetPaymentTransactionEntity|null last()
 */
