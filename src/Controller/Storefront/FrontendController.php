...
class FrontendController extends StorefrontController
{
    ...
    public function successOrder(Request $request, SalesChannelContext $salesChannelContext)
    {
        ...
        $previousDomainId = $salesChannelContext->getDomainId();
        ...
        try {
            ...
            $options = [
                ...
                SalesChannelContextService::DOMAIN_ID => $previousDomainId ?? $request->attributes->get(SalesChannelRequest::ATTRIBUTE_DOMAIN_ID, ''),
