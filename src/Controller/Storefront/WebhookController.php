...
class WebhookController extends StorefrontController
{
    ...
    private function transactionRefund(): string
    {
        ...
        if (! empty($refundAmount)) {
            ...
            {
                $additionalDetails['InstalmentDetails'] = $this->transactionHelper->updateInstalmentCycle($additionalDetails['InstalmentDetails'], $refundAmount,(string) $this->eventTid);
            }
