...
class WebhookController extends StorefrontController
{
    ...
    */
    ...
    public function updateInitialPayment(PaymentMethodEntity $paymentMethod): void
    {
        ...
        $paymentTransaction = new PaymentTransactionStruct($this->orderTransaction->getId(), null);
        $orderTransactionDetails  = $this->transactionHelper->getOrderTransactionDetails($this->orderTransaction->getId());
